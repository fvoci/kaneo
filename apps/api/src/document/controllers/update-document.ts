 ...
 *
 * Saving a body no longer touches which tasks the document references — those
 * are managed through the link endpoints — so this is one statement plus, when
 * the guard fails, a read to explain why.
 */
