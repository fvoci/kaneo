              ...
              {navItems.map((item) => (
                <SidebarMenuItem key={item.url}>
                  ...
                  >
                    ...
                    {item.badge !== null && (
                      <span className="ml-auto flex h-5 min-w-5 items-center justify-center rounded-sm border border-sidebar-border/60 px-1 text-xs font-medium text-sidebar-foreground/80">
                        {item.badge}
                      </span>
                    )}
                  </SidebarMenuButton>
